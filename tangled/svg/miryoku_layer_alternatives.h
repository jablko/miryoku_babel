...
U_NP,              U_NP,              U_LT("Delete", U_FUN),U_LT("Enter", U_NUM),U_LT("Back Space", U_SYM),U_LT("Space", U_MOUSE),U_LT("Tab", U_NAV),U_LT("Esc", U_MEDIA),U_NP,              U_NP
...
U_MT("Q", "Meta"), U_MT("S", "Alt"),  U_MT("D", "Ctrl"), U_MT("F", "Shift"),"G",               "H",               U_MT("J", "Shift"),U_MT("K", "Ctrl"), U_MT("L", "Alt"),  U_MT("M", "Meta"), \
U_LT("W", U_BUTTON),U_MT("X", "AltGr"),"C",               "V",               "B",               "N",               U_S("<", "S_COMM"),U_S(">", "."),     U_SMT("?", "/", "AltGr"),U_SLT(":", ";", U_BUTTON),\
U_NP,              U_NP,              U_LT("Esc", U_MEDIA),U_LT("Tab", U_NAV),U_LT("Space", U_MOUSE),U_LT("Back Space", U_SYM),U_LT("Enter", U_NUM),U_LT("Delete", U_FUN),U_NP,              U_NP
...
U_NP,              U_NP,              "Delete",          "Enter",           "Back Space",      U_NA,              U_HELD(U_NA),      U_NA,              U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_HELD(U_NA),      U_NA,              "Back Space",      "Enter",           "Delete",          U_NP,              U_NP
