...
U_NP,              U_NP,              U_LT("Delete", U_FUN),U_LT("Enter", U_NUM),U_LT("Back Space", U_SYM),U_LT("Space", U_NAV),U_LT("Tab", U_MOUSE),U_LT("Esc", U_MEDIA),U_NP,              U_NP
...
U_MT("Q", "Meta"), U_MT("S", "Alt"),  U_MT("D", "Ctrl"), U_MT("F", "Shift"),"G",               "H",               U_MT("J", "Shift"),U_MT("K", "Ctrl"), U_MT("L", "Alt"),  U_MT("M", "Meta"), \
U_LT("W", U_BUTTON),U_MT("X", "AltGr"),"C",               "V",               "B",               "N",               U_S("<", "S_COMM"),U_S(">", "."),     U_SMT("?", "/", "AltGr"),U_SLT(":", ";", U_BUTTON),\
U_NP,              U_NP,              U_LT("Esc", U_MEDIA),U_LT("Tab", U_MOUSE),U_LT("Space", U_NAV),U_LT("Back Space", U_SYM),U_LT("Enter", U_NUM),U_LT("Delete", U_FUN),U_NP,              U_NP
...
"Q",               "S",               "D",               "F",               "G",               "H",               "J",               "K",               "L",               "M",               \
"W",               "X",               "C",               "V",               "B",               "N",               "S_COMM",          ".",               "/",               ";",               \
U_NP,              U_NP,              "Delete",          "Enter",           "Back Space",      "Space",           "Tab",             "Esc",             U_NP,              U_NP
...
"Q",               "S",               "D",               "F",               "G",               "H",               "J",               "K",               "L",               "M",               \
"W",               "X",               "C",               "V",               "B",               "N",               "S_COMM",          ".",               "/",               ";",               \
U_NP,              U_NP,              "Esc",             "Tab",             "Space",           "Back Space",      "Enter",           "Delete",          U_NP,              U_NP
...
U_NP,              U_NP,              "Delete",          "Enter",           "Back Space",      "Back Space",      U_NA,              U_NA,              U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              "Back Space",      "Back Space",      "Enter",           "Delete",          U_NP,              U_NP
...
U_NA,              "AltGr",           U_DF(U_NUM),       U_DF(U_NAV),       U_NA,              "Home",            "Page Down",       "Page Up",         "End",             "Delete",          \
U_NP,              U_NP,              U_NA,              U_NA,              "Back Space",      "Back Space",      "Enter",           "Delete",          U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV \
U_BOOT,            U_DF(U_TAP),       U_DF(U_EXTRA),     U_DF(U_BASE),      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
"Meta",            "Alt",             "Ctrl",            "Shift",           "Caps Word",       "Insert",          "Left",            "Down",            "Up",              "Right",           \
U_NA,              "AltGr",           U_DF(U_NUM),       U_DF(U_NAV),       U_NA,              "Delete",          "Home",            "Page Down",       "Page Up",         "End",             \
U_NP,              U_NP,              U_NA,              U_NA,              "Back Space",      "Back Space",      "Enter",           "Delete",          U_NP,              U_NP
...
U_NP,              U_NP,              "Middle Button",   "Left Button",     "Right Button",    "Right Button",    U_HELD(U_NA),      U_NA,              U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_HELD(U_NA),      "Right Button",    "Right Button",    "Left Button",     "Middle Button",   U_NP,              U_NP
...
U_NP,              U_NP,              U_HELD(U_NA),      U_NA,              "Space",           "Space",           "Tab",             "App",             U_NP,              U_NP
...
U_NP,              U_NP,              "App",             "Tab",             "Space",           "Space",           U_NA,              U_HELD(U_NA),      U_NP,              U_NP
