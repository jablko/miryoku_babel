...
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              U_MT(PLUS, EQUAL), U_MT(DLLR, N4),    U_MT(PRCNT, N5),   U_MT(CARET, N6),   U_MT(COLON, SEMI), \
U_NA,              &kp RALT,          &u_to_U_NAV,       &u_to_U_NUM,       U_NA,              U_MT(PIPE, BSLH),  U_MT(EXCL, N1),    U_MT(AT, N2),      U_MT(HASH, N3),    U_MT(TILDE, GRAVE),\
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              U_MT(UNDER, MINUS),U_MT(LPAR, N0),    U_MT(RPAR, DOT),   U_NP,              U_NP
...
U_MT(COLON, SEMI), U_MT(DLLR, N4),    U_MT(PRCNT, N5),   U_MT(CARET, N6),   U_MT(PLUS, EQUAL), U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
U_MT(TILDE, GRAVE),U_MT(EXCL, N1),    U_MT(AT, N2),      U_MT(HASH, N3),    U_MT(PIPE, BSLH),  U_NA,              &u_to_U_NUM,       &u_to_U_NAV,       &kp RALT,          U_NA,              \
U_NP,              U_NP,              U_MT(LPAR, DOT),   U_MT(RPAR, N0),    U_MT(UNDER, MINUS),U_NA,              U_NA,              U_NA,              U_NP,              U_NP
