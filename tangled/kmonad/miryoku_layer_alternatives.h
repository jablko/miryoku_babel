...
U_NP,              U_NP,              U_LT(del, U_FUN),  U_LT(ent, U_NUM),  U_LT(bspc, U_SYM), U_LT(spc, U_NAV),  U_LT(tab, U_MOUSE),U_LT(esc, U_MEDIA),U_NP,              U_NP
...
U_MT(q, met),      U_MT(s, alt),      U_MT(d, ctl),      U_MT(f, sft),      g,                 h,                 U_MT(j, sft),      U_MT(k, ctl),      U_MT(l, alt),      U_MT(m, met),      \
U_LT(w, U_BUTTON), U_MT(x, ralt),     c,                 v,                 b,                 n,                 U_COMM,            .,                 U_MT(/, ralt),     U_LT(;, U_BUTTON), \
U_NP,              U_NP,              U_LT(esc, U_MEDIA),U_LT(tab, U_MOUSE),U_LT(spc, U_NAV),  U_LT(bspc, U_SYM), U_LT(ent, U_NUM),  U_LT(del, U_FUN),  U_NP,              U_NP
...
U_NP,              U_NP,              del,               ent,               bspc,              bspc,              U_NA,              U_NA,              U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              bspc,              bspc,              ent,               del,               U_NP,              U_NP
